...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold">Dodaj nową wizytę</h1>
        ...
        <form action="{{ route('visits.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <select 
                    ...
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
                    <option value="scheduled" {{ old('status') == 'scheduled' ? 'selected' : '' }}>Zaplanowana</option>
